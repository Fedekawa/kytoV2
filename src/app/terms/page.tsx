          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow p-6 md:p-8">
            ...
            <div className="prose prose-blue max-w-none">
              ...
              <p className="text-blue-900/70 mb-4">
                Kyto provides advanced tools and services designed to enhance business communication and commerce through WhatsApp 
                and related technologies. These Terms constitute a legally binding agreement between you and Kyto regarding your use 
                of our Services.
              </p>
              ...
              <p className="text-blue-900/70 mb-4">
                By accessing or using our Services, you agree to these Terms and the WhatsApp Business Terms of Service. If you are 
                using the Services on behalf of a business or entity, you represent and warrant that you have the authority to bind 
                that entity to these Terms and WhatsApp's terms. In that case, "you" and "your" will refer to that entity.
              </p>

              {/* Section 4 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">4. Service Description</h2>
              <p className="text-blue-900/70 mb-4">
                Kyto provides WhatsApp Business Solution Provider services and tools to improve business communication and commerce. 
              ...
              <p className="text-blue-900/70 mt-4">
                The specific features may evolve over time, and we reserve the right to modify, add, or remove features without prior notice.
              </p>

              {/* New Section 5 - WhatsApp Business Services */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">5. WhatsApp Business Services</h2>
              ...
              <p className="text-blue-900/70 mt-4">Your use of our WhatsApp-related services must comply with:</p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">6. Eligibility</h2>
              <p className="text-blue-900/70 mb-4">To use our Services, you must:</p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">9. WhatsApp-Specific Requirements</h2>
              <p className="text-blue-900/70 mb-4">You agree to:</p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              <h3 className="text-xl font-bold text-blue-900 mt-6 mb-3">Data Processing</h3>
              <p className="text-blue-900/70 mb-4">You acknowledge that:</p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              <h3 className="text-xl font-bold text-blue-900 mt-6 mb-3">Message Templates</h3>
              <p className="text-blue-900/70 mb-4">You agree to:</p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">10. Fees and Payments</h2>
              <p className="text-blue-900/70 mb-4">
                Access to certain features of the Services may require payment. All fees are non-refundable unless otherwise stated. 
                This includes WhatsApp messaging fees and template charges. You agree to:
              </p>
              <ul className="list-disc list-inside text-blue-900/70 space-y-2 ml-4">
              ...
              {/* Section 9 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">11. Intellectual Property Rights</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 10 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">12. Privacy and Data Protection</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 11 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">13. Third-Party Services and Links</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 12 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">14. Service Modifications and Availability</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 13 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">15. Termination and Account Cancellation</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 14 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">16. Disclaimer of Warranties</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 15 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">17. Limitation of Liability</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 16 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">18. Indemnification</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 17 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">19. Dispute Resolution</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 18 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">20. Governing Law</h2>
              <p className="text-blue-900/70 mb-4">
                These Terms are governed by the laws of Colombia, without regard to conflict of laws principles. Any disputes not resolved through arbitration 
                will be litigated exclusively in the courts of Bogota, Colombia.
              </p>

              {/* Section 19 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">21. Severability</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 21 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">23. Changes to This Agreement</h2>
              <p className="text-blue-900/70 mb-4">
              ...
              {/* Section 22 */}
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">24. Contacting Us</h2>

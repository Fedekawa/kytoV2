...
export default function NapolesPage() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      // Add custom styles for the widget if needed
    ...
    <main className="min-h-screen pt-16 md:pt-24 bg-gradient-to-b from-white to-gray-100">
      <div className="container mx-auto px-4">
        ...
        {!isAuthenticated ? (
          ...
          >
            <motion.div 
              className="inline-flex items-center gap-3 text-3xl font-bold text-blue-900 mb-8 p-6 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm"
